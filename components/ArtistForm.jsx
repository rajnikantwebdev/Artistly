              ...
              <div className="space-y-8" />
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          ...
                          rows={4}
                          className="border-2 text-gray-700 border-gray-200 focus:border-purple-500 rounded-lg resize-none"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <FormItem>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                    {categories.map((cat) => (
                      <label key={cat} className="flex items-center space-x-3 cursor-pointer hover:bg-white p-2 rounded transition-colors">
                        <Checkbox
                ...
                <FormItem>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                    {languages.map((lang) => (
                      <label key={lang} className="flex items-center space-x-3 cursor-pointer hover:bg-white p-2 rounded transition-colors">
                        <Checkbox
