...
const ArtistCard = ({artist, Icon}) => {    
  return (
    <Card className="group sm:flex hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-white/80 backdrop-blur-sm border-0 shadow-lg px-0 py-0">
      <CardContent className="sm:w-2/5 py-6">
      ...
      <CardContent className="bg-gradient-to-r from-purple-600 to-blue-600 sm:w-3/5 rounded-b-2xl sm:rounded-bl-none sm:rounded-r-2xl py-6">
        <div className="h-4/5">
          <div>
        ...
        <div className="h-1/5 sm:mt-0 mt-4">
