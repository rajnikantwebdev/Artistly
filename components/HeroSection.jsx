      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="pt-4">
            <Link
              href={"/artists"}
              size="lg"
              className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 rounded-full"
            >
              Explore Artists
            </Link>
        </div>
